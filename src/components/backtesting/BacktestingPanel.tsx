    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-xs text-blue-600 mt-2">
          {import.meta.env.VITE_POLYGON_API_KEY && import.meta.env.VITE_POLYGON_API_KEY.length >= 20 && !import.meta.env.VITE_POLYGON_API_KEY.includes('your_polygon_api_key') && !import.meta.env.VITE_POLYGON_API_KEY.includes('K95sJvRRPEyVT_EMrTip0aAAlvrkHp8X')
